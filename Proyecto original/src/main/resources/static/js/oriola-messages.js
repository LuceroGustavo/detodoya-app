/**
 * Sistema de Mensajes Oriola
 * Muestra mensajes de error y éxito con estilo minimalista
 * "Oriola dice:" - Rojo para errores, Verde para éxitos
 */

class OriolaMessages {
    constructor() {
        this.init();
    }
    ...
    init() {
        ...
        if (!document.getElementById('oriola-messages-container')) {
            const container = document.createElement('div');
            container.id = 'oriola-messages-container';
    ...
    showMessage(message, type = 'info', duration = 5000) {
        const container = document.getElementById('oriola-messages-container');
        if (!container) {
            this.init();
