#!/bin/bash
# menu-deploy-donweb-nuevo.sh - Menú interactivo para gestión de OriolaIndumentaria
...
print_header() {
    ...
    echo -e "   Servidor: Donweb - 66.97.45.252"
    echo -e "==========================================${NC}"
}
...
start_app() {
    ...
    if check_app_status; then
        ...
        echo -e "${CYAN}🌐 Disponible en: http://66.97.45.252:8080${NC}"
    else
...
project_info() {
    ...
    echo "Servidor: Donweb (Nuevo)"
    echo "IP: 66.97.45.252"
    echo "Perfil: donweb"
}
