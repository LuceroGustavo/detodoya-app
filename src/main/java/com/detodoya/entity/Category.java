...
public class Category {
    ...
    // Tipo de producto por defecto para esta categoría (opcional)
    @Column(name = "tipo_producto_default")
    @Enumerated(EnumType.STRING)
    private TipoProducto tipoProductoDefault; // Tipo de producto sugerido para productos en esta categoría
    ...
    /**
     * Obtiene el tipo de producto de esta categoría
     * Si no tiene tipo definido, retorna OTROS
     */
